/**
 * @file plugins/blocks/keywordCloudClassicBeautiful/js/keywordCloud.js
 *
 * Copyright (c) 2026 OJSBR (https://ojsbr.com)
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * Draws the keyword cloud with the vendored layout library and gives the words on
 * the canvas a real hover and click affordance. Without it the block stays an
